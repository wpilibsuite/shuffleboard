...
final class Loggers {
  ...
  static void setupLoggers() throws IOException {
    ...
    final Handler fileHandler =
        new FileHandler(Storage.getStorageDir() + "/shuffleboard." + time + ".log");
    ...
    final StreamHandler sh =
        new StreamHandler(System.out, new SimpleFormatter()) {
          ...
          public synchronized void publish(
              final LogRecord record) { // NOPMD this is the same signature as the superclass
