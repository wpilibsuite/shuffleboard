...
import static edu.wpi.first.shuffleboard.app.sources.recording.Serialization.SIZE_OF_DOUBLE;
import static edu.wpi.first.shuffleboard.app.sources.recording.Serialization.SIZE_OF_INT;
import static edu.wpi.first.shuffleboard.app.sources.recording.Serialization.encode;
import static edu.wpi.first.shuffleboard.app.sources.recording.Serialization.put;
import static edu.wpi.first.shuffleboard.app.sources.recording.Serialization.toByteArray;
