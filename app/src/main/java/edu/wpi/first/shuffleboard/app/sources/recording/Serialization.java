...
import edu.wpi.first.shuffleboard.app.sources.recording.serialization.BooleanArrayAdapter;
import edu.wpi.first.shuffleboard.app.sources.recording.serialization.ByteArrayAdapter;
import edu.wpi.first.shuffleboard.app.sources.recording.serialization.NumberArrayAdapter;
import edu.wpi.first.shuffleboard.app.sources.recording.serialization.Serializers;
import edu.wpi.first.shuffleboard.app.sources.recording.serialization.StringArrayAdapter;
import edu.wpi.first.shuffleboard.app.sources.recording.serialization.TypeAdapter;
import edu.wpi.first.shuffleboard.app.sources.recording.serialization.SendableChooserAdapter;
import edu.wpi.first.shuffleboard.app.sources.recording.serialization.SimpleAdapter;
import edu.wpi.first.shuffleboard.app.sources.recording.serialization.StringAdapter;
