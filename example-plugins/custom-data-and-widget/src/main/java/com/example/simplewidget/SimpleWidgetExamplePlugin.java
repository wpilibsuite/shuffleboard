...
/**
 * An example plugin that provides a custom data type (a 2D point) and a simple widget for viewing
 * such data.
 */
@Description(
    group = "com.example",
...
public final class SimpleWidgetExamplePlugin extends Plugin {
  ...
  public List<ComponentType> getComponents() {
    return List.of(WidgetType.forAnnotatedWidget(SimplePointWidget.class));
  }

  @Override
  public Map<DataType, ComponentType> getDefaultComponents() {
    return Map.of(PointType.Instance, WidgetType.forAnnotatedWidget(SimplePointWidget.class));
  }
}
