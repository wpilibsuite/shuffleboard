...
public final class Resolution {
  ...
  /**
   * Checks if this resolution is not equal to the given dimensions, ie {@code getWidth() != width
   * || getHeight() != height}.
   *
   * @param width the width to check
   * @param height the height to check
   * @return true if either {@code width} or {@code height} is different from this resolution's
