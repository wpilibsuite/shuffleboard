...
dependencies {
    ...
    compile(group = "edu.wpi.first.thirdparty.frc2019.opencv", name = "opencv-java", version = "3.4.4-3")
    native(group = "edu.wpi.first.thirdparty.frc2019.opencv", name = "opencv-jni", version = "3.4.4-3", classifierFunction = ::wpilibClassifier)
