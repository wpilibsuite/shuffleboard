...
public class FieldConfigurationTest {
  ...
  public void testGetConfig(
      Configuration expected, Element element, Alliance alliance, String gameSpecificMessage) {
  ...
  public void testParseFmsInfo() {
    FmsInfo info =
        new FmsInfo("LRL", "", 0, 0, MatchType.NONE, Alliance.BLUE, 0, ControlWord.fromBits(0));
