...
public final class FieldConfiguration {
  ...
  public FieldConfiguration(
      Configuration nearSwitch, Configuration scale, Configuration farSwitch) {
  ...
  /**
   * Parses FMS info to extract the field configuration. If the game-specific message is incorrectly
   * formatted, returns
   *
