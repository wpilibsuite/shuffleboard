...
@Description(
    name = "Voltage View",
    dataTypes = {NumberType.class, AnalogInputType.class})
...
public class VoltageViewWidget extends SingleSourceWidget implements AnnotatedWidget {
  ...
  private void initialize() {
            ...
            EasyBind.combine(
                ...
                (data, min, max) -> {
                  ...
                  if (data instanceof Number) {
                    ...
                    value = 0;
                    log.warning(
                        "Unexpected data: " + data + " (Source: " + getSource() + ")"); // NOPMD
                  }
                  return value;
                }));
    indicator
    ...
    indicator.setLabelFormatter(
        new UnitStringConverter("V")); // "Volts" is too long and causes clipping issues
  }
