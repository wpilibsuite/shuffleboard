...
public final class GridLayoutSaver implements ElementTypeAdapter<GridLayout> {
  ...
  private static final StringConverter<GridPoint> pointConverter =
      new StringConverter<GridPoint>() {
  ...
  @Override
  public GridLayout deserialize(JsonElement json, JsonDeserializationContext context)
      throws JsonParseException {
    JsonObject obj = json.getAsJsonObject();
    GridLayout gridLayout =
        Components.getDefault()
            .createComponent("Grid Layout")
