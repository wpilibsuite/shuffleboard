...
public class PowerDistributionPanelWidget extends SimpleAnnotatedWidget<PowerDistributionData> {
  ...
  private final BooleanProperty showIndicatorText =
      new SimpleBooleanProperty(this, "showIndicatorText", true);

  @FXML private Pane root;
  @FXML private ImageView imageView;
  @FXML private LinearIndicator channel0;
  @FXML private LinearIndicator channel1;
  @FXML private LinearIndicator channel2;
  @FXML private LinearIndicator channel3;
  @FXML private LinearIndicator channel4;
  @FXML private LinearIndicator channel5;
  @FXML private LinearIndicator channel6;
  @FXML private LinearIndicator channel7;
  @FXML private LinearIndicator channel8;
  @FXML private LinearIndicator channel9;
  @FXML private LinearIndicator channel10;
  @FXML private LinearIndicator channel11;
  @FXML private LinearIndicator channel12;
  @FXML private LinearIndicator channel13;
  @FXML private LinearIndicator channel14;
  @FXML private LinearIndicator channel15;
  @FXML private LinearIndicator channel16;
  @FXML private LinearIndicator channel17;
  @FXML private LinearIndicator channel18;
  @FXML private LinearIndicator channel19;
  @FXML private LinearIndicator channel20;
  @FXML private LinearIndicator channel21;
  @FXML private LinearIndicator channel22;
  @FXML private LinearIndicator channel23;
  @FXML private LinearIndicator voltage;
  @FXML private LinearIndicator totalCurrent;
  @FXML private Label voltageText;
  @FXML private Label totalCurrentText;
  ...
  private void initialize() {
    channels =
        new LinearIndicator[] {
          ...
          channel17, channel18, channel19, channel20, channel21, channel22, channel23
        };
        ...
        .addListener(
            (__, oldData, newData) -> {
              ...
              for (int i = 0; i < currents.length; i++) {
                ...
                FxUtils.getLabel(channels[i])
                    .ifPresent(label -> label.setText(ampConverter.toString(current)));
