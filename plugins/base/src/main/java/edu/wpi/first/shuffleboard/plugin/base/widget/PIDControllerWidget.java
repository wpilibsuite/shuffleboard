...
/**
 * A widget for controlling PID controllers. This gives control over the four PIDF constants, the
 * controller setpoint, and whether or not the controller is enabled.
 */
...
public class PIDControllerWidget extends SimpleAnnotatedWidget<PIDControllerData> {
  ...
  @FXML private NumberField pField;
  @FXML private NumberField iField;
  @FXML private NumberField dField;
  @FXML private NumberField setpointField;
