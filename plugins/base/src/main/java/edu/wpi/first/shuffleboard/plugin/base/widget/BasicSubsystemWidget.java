...
public final class BasicSubsystemWidget extends SimpleAnnotatedWidget<BasicSubsystemData> {
  ...
  @FXML private Label defaultCommandLabel;
  @FXML private Label currentCommandLabel;

  private MonadicBinding<String>
      defaultCommandText; // NOPMD could be local variable -- in a field to avoid GC
  private MonadicBinding<String>
      currentCommandText; // NOPMD could be local variable -- in a field to avoid GC
