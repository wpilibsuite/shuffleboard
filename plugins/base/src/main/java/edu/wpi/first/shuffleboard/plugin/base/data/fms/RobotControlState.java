...
public enum RobotControlState {
  ...
  /**
   * The robot is disabled. This can be because the match has not started, the match has ended, the
   * robot has been emergency stopped, the robot lost connection to the FMS, or the robot rebooted
   * mid-match.
   */
  Disabled,
