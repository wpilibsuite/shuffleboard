...
public class GridLayoutTest extends ApplicationTest {
  ...
  public void testReduceRowCount() {
    ...
    assertEquals(
        6,
        getPlaceholderCount(),
        "Removing a row should reduce the number of placeholders from 9 to 6");
  }
  ...
  public void testIncreaseRowCount() {
    ...
    assertEquals(
        12,
        getPlaceholderCount(),
        "Adding a row should increase the number of placeholders from 9 to 12");
  }
  ...
  public void testReduceColumnCount() {
    ...
    assertEquals(
        6,
        getPlaceholderCount(),
        "Removing a column should reduce the number of placeholders from 9 to 6");
  }
  ...
  public void testIncreaseColumnCount() {
    ...
    assertEquals(
        12,
        getPlaceholderCount(),
        "Adding a column should increase the number of placeholders from 9 to 12");
  }

  private long getPlaceholderCount() {
    return grid.getChildren().stream().filter(n -> n instanceof GridLayout.Placeholder).count();
  }
  ...
  public void testAddNewRowWhenFull() {
    ...
    assertEquals(
        2,
        layout.getNumRows(),
        "Adding a second child with 1 row should have caused a new row to be created");
  }
}
