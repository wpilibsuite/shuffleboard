...
public final class DragUtils {
   ...
   * @return the data for the given data format, or <code>null</code> if no such data is present in
   *     the dragboard
   * @throws ClassCastException if the content in the dragboard for the data format is not of type
   *     <code>T</code>
   */
