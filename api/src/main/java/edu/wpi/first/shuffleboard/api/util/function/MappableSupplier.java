...
public interface MappableSupplier<T> extends Supplier<T> {
  ...
  /**
   * Creates a new mappable supplier whose output corresponds, roughly, to {@code
   * mappingFunction.apply(get())}.
   *
   * @param mappingFunction the function to use to map the output of this supplier to a different
   *     value
