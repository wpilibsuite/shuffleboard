...
public final class ReflectionUtils {
  ...
  /**
   * Gets the value of a field. Reflective exceptions are wrapped and re-thrown as a runtime
   * exception.
   *
   * @param instance the instance of the class to get the field's value from
   * @param field the field to get the value of
   * @param <T> the type of object in the field
   * @return the value of the field
   * @throws RuntimeException if a reflective exception was thrown while attempting to get the value
   *     of the field
   */
  ...
  /**
   * Gets the output value of a method. Reflective exceptions are wrapped and re-thrown as a runtime
   * exception.
   *
   ...
   * @param <T> the return type of the method
   * @return the output of the method
   * @throws RuntimeException if a reflective exception was thrown while attempting to call the
   *     method
   */
