...
public interface SingleTypeWidget<T> extends Widget {
  ...
  /**
   * Gets a property containing the value of the source. This is used for brevity and is a shortcut
   * for {@code EasyBind.monadic(sourceProperty()).selectProperty(DataSource::dataProperty)}
   */
