...
/**
 * Wraps a normal JavaFX property in a styleable wrapper property. Changes to the wrapper property
 * will be propagated to the initial property.
 *
...
public class SimpleStyleableObjectPropertyWrapper<T> extends SimpleStyleableObjectProperty<T> {
   ...
   */
  public SimpleStyleableObjectPropertyWrapper(
      CssMetaData<? extends Styleable, T> cssMetaData, Property<T> property) {
