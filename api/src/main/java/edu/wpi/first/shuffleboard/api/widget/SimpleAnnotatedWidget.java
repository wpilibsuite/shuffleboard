...
public abstract class SimpleAnnotatedWidget<T> extends SingleSourceWidget
  ...
  /**
   * A read-only binding of the data for this widget. If this widget has a source, this is
   * equivalent to {@link #dataProperty()}; otherwise, it contains the default value of this widgets
   * data type.
   */
