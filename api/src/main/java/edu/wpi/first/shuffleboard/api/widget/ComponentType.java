...
/**
 * A ComponentType is a Java object that encapsulates a single "variety" of component that the user
 * could instantiate.
 *
 * <p>It can be thought of as a wrapper around Class&lt;? extends Component&gt; with a more useful
 * API and additional metadata.
 */
