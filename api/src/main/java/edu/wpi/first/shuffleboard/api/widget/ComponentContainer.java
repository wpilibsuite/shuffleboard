...
public interface ComponentContainer {
  ...
  /**
   * Adds a component to this container. Where and how the component is laid out is up to the
   * implementation.
   *
  ...
  /**
   * Adds a component to this container from a model object. The model may specify position and
   * size, which implementations must respect if those properties are supported.
   *
   * @param model the model for the component to add
   * @return the component object that was added to this container, or null if no component was
   *     added
   */
