...
public final class Maps {
  ...
  /**
   * An unsafe version of {@link Map#computeIfAbsent(Object, Function) Map.computeIfAbsent} that may
  ...
  public static <K, V, X extends Throwable> V computeIfAbsent(
      Map<K, V> map, K key, ThrowingFunction<? super K, ? extends V, ? extends X> function)
      throws X {
   ...
   * @return the
   * @throws ClassCastException if the element is present in the map, but is not an instance of
   *     {@code T}
   */
  ...
  public static final class MapBuilder<K, V> {
    ...
    /**
     * Puts the given key-value entry into the map and returns this builder to allow for method
     * chaining.
     *
