...
/**
 * A subclass of {@link Gauge} that allows various UI properties to be styled with CSS. Gauges are
 * able to be styled on a per-skin basis with the pseudoclass for that skins name; for example, a
 * gauge with the {@code FLAT} skin can be styled with {@code .gauge:flat} without affecting other
 * gauge types.
 */
public class StyleableGauge extends Gauge {

  private static final Map<SkinType, PseudoClass> skinTypePseudoClasses =
      new EnumMap<>(SkinType.class);
  ...
  private static final class GaugeCss {
    ...
    private static final CssMetaData<Gauge, Color> BAR_BACKGROUND_COLOR =
        new SimpleColorCssMetaData<>("-fx-bar-background-color", Gauge::barBackgroundColorProperty);
    private static final CssMetaData<Gauge, Color> BAR_BORDER_COLOR =
        new SimpleColorCssMetaData<>("-fx-bar-border-color", Gauge::barBorderColorProperty);
    private static final CssMetaData<Gauge, Color> BAR_COLOR =
        new SimpleColorCssMetaData<>("-fx-bar-color", Gauge::barColorProperty);
    private static final CssMetaData<Gauge, Paint> BORDER_PAINT =
        new SimpleCssMetaData<>(
            "-fx-border-color", StyleConverter.getPaintConverter(), Gauge::borderPaintProperty);
    private static final CssMetaData<Gauge, Number> BORDER_WIDTH =
        new SimpleCssMetaData<>(
            "-fx-border-width", StyleConverter.getSizeConverter(), Gauge::borderWidthProperty);
    private static final CssMetaData<Gauge, Font> CUSTOM_FONT =
        new SimpleCssMetaData<>(
            "-fx-custom-font", StyleConverter.getFontConverter(), Gauge::customFontProperty);
    ...
    private static final CssMetaData<Gauge, Color> KNOB_COLOR =
        new SimpleColorCssMetaData<>("-fx-knob-color", Gauge::knobColorProperty);
    private static final CssMetaData<Gauge, KnobType> KNOB_TYPE =
        new SimpleCssMetaData<>(
            "-fx-knob-type", new EnumConverter<>(KnobType.class), Gauge::knobTypeProperty);
    private static final CssMetaData<Gauge, Boolean> KNOB_VISIBLE =
        new SimpleCssMetaData<>(
            "-fx-knob-visible", StyleConverter.getBooleanConverter(), Gauge::knobVisibleProperty);
    private static final CssMetaData<Gauge, Color> MAJOR_TICK_COLOR =
        new SimpleColorCssMetaData<>("-fx-major-tick-color", Gauge::majorTickMarkColorProperty);
    private static final CssMetaData<Gauge, Color> MEDIUM_TICK_COLOR =
        new SimpleColorCssMetaData<>("-fx-medium-tick-color", Gauge::mediumTickMarkColorProperty);
    private static final CssMetaData<Gauge, Color> MINOR_TICK_COLOR =
        new SimpleColorCssMetaData<>("-fx-minor-tick-color", Gauge::minorTickMarkColorProperty);
    private static final CssMetaData<Gauge, Color> NEEDLE_COLOR =
        new SimpleColorCssMetaData<>("-fx-needle-color", Gauge::needleColorProperty);
    private static final CssMetaData<Gauge, NeedleShape> NEEDLE_SHAPE =
        new SimpleCssMetaData<>(
            "-fx-needle-shape", new EnumConverter<>(NeedleShape.class), Gauge::needleShapeProperty);
    private static final CssMetaData<Gauge, NeedleSize> NEEDLE_SIZE =
        new SimpleCssMetaData<>(
            "-fx-needle-size", new EnumConverter<>(NeedleSize.class), Gauge::needleSizeProperty);
    private static final CssMetaData<Gauge, NeedleType> NEEDLE_TYPE =
        new SimpleCssMetaData<>(
            "-fx-needle-type", new EnumConverter<>(NeedleType.class), Gauge::needleTypeProperty);
    private static final CssMetaData<Gauge, Number> START_ANGLE =
        new SimpleCssMetaData<>(
            "-fx-start-angle", StyleConverter.getSizeConverter(), Gauge::startAngleProperty);
    private static final CssMetaData<Gauge, Color> SUBTITLE_COLOR =
        new SimpleColorCssMetaData<>("-fx-subtitle-color", Gauge::subTitleColorProperty);
    private static final CssMetaData<Gauge, Color> TICK_LABEL_COLOR =
        new SimpleColorCssMetaData<>("-fx-tick-label-color", Gauge::tickLabelColorProperty);
    private static final CssMetaData<Gauge, Color> TICK_MARK_COLOR =
        new SimpleColorCssMetaData<>("-fx-tick-mark-color", Gauge::tickMarkColorProperty);
    ...
    private static final CssMetaData<Gauge, Color> TITLE_COLOR =
        new SimpleColorCssMetaData<>("-fx-title-color", Gauge::titleColorProperty);
    private static final CssMetaData<Gauge, Color> UNIT_COLOR =
        new SimpleColorCssMetaData<>("-fx-unit-color", Gauge::unitColorProperty);
    private static final CssMetaData<Gauge, Color> VALUE_COLOR =
        new SimpleColorCssMetaData<>("-fx-value-color", Gauge::valueColorProperty);
    private static final CssMetaData<Gauge, Color> ZERO_COLOR =
        new SimpleColorCssMetaData<>("-fx-zero-color", Gauge::zeroColorProperty);
