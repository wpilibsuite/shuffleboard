...
public class ComponentModelImplTest {
  ...
  public void testPath() {
    ComponentModel component = new ComponentModelImpl("path", null, null, Collections.emptyMap(), true);
  ...
  public void testParent() {
    ...
    ComponentModel component = new ComponentModelImpl("", parent, null, Collections.emptyMap(), true);
  ...
  public void testDisplayType() {
    ...
    ComponentModel component = new ComponentModelImpl("", null, displayType, Collections.emptyMap(), true);
  ...
  public void testProperties() {
    ...
    ComponentModel component = new ComponentModelImpl("", null, null, properties, true);
  ...
  public void testPreferredPosition() {
    ComponentModel component = new ComponentModelImpl("", null, "", Collections.emptyMap(), true);
  ...
  public void testTitle() {
    ComponentModel component = new ComponentModelImpl("/Shuffleboard/Tab/X/Y/Foo", null, null, Collections.emptyMap(), true);
